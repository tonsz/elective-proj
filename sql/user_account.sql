...
INSERT INTO `candidates_tbl` (`cand_id`, `cand_name`, `cand_age`, `cand_desc1`, `cand_desc2`, `cand_desc3`, `cand_image_path`, `cand_election`) VALUES
(5, 'Calliope', 19, 'A', 'B', 'C', '../uploads/Calliope.jpg', 1999);
...
--
ALTER TABLE `candidates_tbl`
  MODIFY `cand_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
